      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            {user && (
              <>
                <div className="flex items-center space-x-3 bg-gradient-to-r from-violet-500/10 to-fuchsia-500/10 px-5 py-2.5 rounded-full border border-violet-500/30 hover:border-violet-500/50 transition-all duration-300 backdrop-blur-sm">
                  <img
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-slate-950/95 backdrop-blur-sm border-t border-violet-500/20">
          <div className="px-4 py-4 space-y-3">
            {user && (
              <>
                <div className="flex items-center space-x-3 bg-gradient-to-r from-violet-500/10 to-fuchsia-500/10 px-4 py-3 rounded-xl border border-violet-500/30">
                  <img
                    src={user.photoURL || 'https://ui-avatars.com/api/?name=' + encodeURIComponent(user.displayName || 'User')}
                    alt={user.displayName}
