    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center p-4">
      <div className="max-w-4xl w-full animate-fade-in">
        ...
        <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl p-8 rounded-3xl border border-violet-500/20 max-w-md mx-auto animate-slide-up shadow-2xl shadow-violet-500/10" style={{ animationDelay: '0.4s' }}>
          <h2 className="text-2xl font-bold text-white mb-6 text-center">Почніть зараз</h2>
          ...
          <p className="mt-6 text-slate-400 text-sm text-center">
            Увходячи, ви погоджуєтесь з нашими умовами використання та політикою конфіденційності
          </p>
        </div>
      </div>
    </div>
