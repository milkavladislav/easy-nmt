          ...
          <div className="bg-gradient-to-br from-orange-800/50 to-amber-900/50 backdrop-blur-xl rounded-3xl border border-orange-500/20 overflow-hidden mb-8 shadow-2xl shadow-orange-500/10">
            ...
            <div className="p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center space-x-4 bg-gradient-to-r from-orange-500/10 to-amber-500/10 p-4 rounded-2xl border border-orange-500/20">
                ...
                <div className="flex items-center space-x-4 bg-gradient-to-r from-amber-500/10 to-yellow-500/10 p-4 rounded-2xl border border-amber-500/20">
                ...
                <div className="flex items-center space-x-4 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 p-4 rounded-2xl border border-yellow-500/20">
              ...
              {isEditing && (
                <div className="mt-6 flex justify-center gap-4">
                  <button
                    ...
                    className="bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-orange-500/25"
                  >
                    Зберегти
                  </button>
                  <button
